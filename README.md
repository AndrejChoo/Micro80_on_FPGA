...
В папке Micro80 файлы проектов, созданных для FPGA Altera, Gowin и Xilinx (не весь проект целиком, а только HDL файлы и некоторые сгенерированные ip блоки). Для FPGA других производителей будет необходимо сгенерировать свои ip блоки pll, блочной памяти.
