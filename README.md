...
Пока что проект достоверно работает только на ПЛИС Altera (Cyclone4 и Cyclone10LP) и Gowin TangNano9k. Пытаюсь запустить его на Xilinx Artix7, Xilinx Spartan 6 - пока безуспешно. Ближе всего к запуску - Artix7, он зависает на обновлении экрана в  CPM.
